...
public class MainIntegrationTest {
    ...
    public void testAppBaseFormatJson(LaunchResult result) {
        Assertions.assertEquals(
                "{\"mypath/to-parameters/key2\": \"value2\",\"mypath/to-parameters/key1\": \"value1\"}",
                result.getOutput());
    }
    ...
    @Test
    @Launch(
            value = {"--output", "TEMPLATE", "--template", "/my/path/to/template"},
            exitCode = 1)
    public void testAppValidTemplateWithTemplatePathFileNonExistent(LaunchResult result) {}

    @Test
    @Launch(
            value = {"--output", "TEMPLATE", "--template", "/home/jhudson/sources/jget-ssm-params/test.tpl"},
            exitCode = 0)
